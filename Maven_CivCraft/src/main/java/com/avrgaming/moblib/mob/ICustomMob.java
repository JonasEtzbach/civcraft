package com.avrgaming.moblib.mob;
...
public interface ICustomMob<PathfinderGoalSelector> {
	...
	public void onDamage(EntityCreature e, DamageSource source, PathfinderGoalSelector goalSelector,
