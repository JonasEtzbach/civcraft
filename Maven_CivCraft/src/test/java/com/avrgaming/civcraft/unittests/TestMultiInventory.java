...
//	}
	...
	/*
	 * Asserts that we can 1) create a new multi-inventory. 2) add a single item to
	 * the inventory. 3) verify it was the only one added.
	 * 
	 */
	@Test
	public void addSingleItemToInventory() {
		...
		// assertEquals(multiInv.addItem(ItemManager.createItemStack(CivData.BOW, 1)),
		// 1);

		/* Verify that this inventory now has 1 item. */
		// assertEquals("Inventory Has One Item", 1,
		// getItemCount(multiInv.getContents()));
